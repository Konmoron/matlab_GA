%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ---- 本脚本用于根据目标函数objFuncByFreqAndS11_Scores_V4执行遗传算法 ---- %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    % ---- 注释 ---- %
        % ---- 本脚本的主要作用是：
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % ---- 1.根据目标函数objFuncByFreqAndS11_Scores_V4执行遗传算法
            % ---- 2.整个程序的入口
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% ---- 开始时间
    startTime = clock;
%% ---- 声明全局变量
    global count objFreq m n tmpfileDirectory numOfSwitch indexOfObjFreqInS11;
%% ---- 设定天线阵列的行数和列数
    % ---- 设定行数m
        m = 5;
    % ---- 设定列数n
...
%% ---- 得到计算适应度的起始S11索引和终止S11索引
    % ---- 得到求解频率对应的S11参数的位置
        ...
        %}
        indexOfObjFreqInS11 = (objFreq - startFreq) * 100 + 1;
    % ---- 将indexOfObjFreqInS11转化为整型
    %{ 
        ---- 注意 ----
        ---- 注意 ----
        ---- 注意 ----
            之所以要用int32这个函数，是因为索引只能是正整数，
            而indexOfObjFreqInS11得到的结果是double类型的，所以需要转化为整数类型的
        ---- 注意 ----
        ---- 注意 ----
        ---- 注意 ----
    %}
        indexOfObjFreqInS11 = int32(indexOfObjFreqInS11);
%% ---- 定义统计变量
    %{
        ---- 注意 ----
        ---- 注意 ----
    ...
    count = 1;
%% ---- 设置目标函数
    FitnessFcn = @objFuncByFreqAndS11_Scores_V4;
