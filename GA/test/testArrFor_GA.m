...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % ---- 注释 ---- %
        % ---- 本脚本只是用于产生一个数组SwitchArrayOf_M_N_R_A_Model_GA
        % ---- 这个数组SwitchArrayOf_M_N_R_A_Model_GA包含3个数组
            % ---- 每个数组由0和1组成
                % ---- 0代表开关断开
                % ---- 1代表开关闭合
                % ---- 数组的长度由开关的个数决定
...
%% ---- 将所有开关组合存入一个数组中
    % ---- 定义SwitchArrayOf_M_N_R_A_Model_GA
        %{ 
            ---- 注意 ----
            ---- 注意 ----
            ---- 注意 ----
               SwitchArrayOf_M_N_R_A_Model_GA(1, :)代表SwitchArray1，其他以此类推
                    其中，
