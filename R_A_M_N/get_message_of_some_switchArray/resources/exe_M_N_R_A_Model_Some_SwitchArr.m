...
%% ---- 定义文件名
     %{
        ...
        ---- 注意 ----
    %}
    fileName = ['SwitchArray' num2str(tmpSwtichArray(end)) '_For_' num2str(m) '_' num2str(n) '_R_A'];
%% ---- 创建工程文件
    ...
    % ---- 加载模型脚本
        %{
            ...
            ---- 注意 ----
                ...
                关于模型的创建，参见create_M_N_R_A_Model.m
            ---- 注意 ----
            ---- 注意 ----
            ---- 注意 ----
        %}
...
%% ---- 加载setupParametersOfHFSS脚本
    %{
        ...
        ---- 注意 ----
            ...
            详细信息请参见setupParam_HFSS_Some_SwitchArr.m脚本
        ---- 注意 ----
        ---- 注意 ----
        ---- 注意 ----
    %}
    setupParam_HFSS_Some_SwitchArr;
%% ---- 添加求解频率
