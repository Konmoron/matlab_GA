...
fprintf(fid, 'Array("X Component:=", "Freq", "Y Component:=", Array("S Parameter")), _\n');
fprintf(fid, 'Array() \n');
% sorry, this is just fo my work, you can modify it by yourself.
% fprintf(fid, 'Array("Phi:=", Array( "All"), "Theta:=", Array("90deg"), "Freq:=", Array("%fGHz")), _\n', freq);
% fprintf(fid, 'Array("X Component:=", "Phi", "Y Component:=", Array("rETotal")), _\n');
% fprintf(fid, 'Array() \n');