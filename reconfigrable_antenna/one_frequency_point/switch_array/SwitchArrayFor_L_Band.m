...
%% ---- 创建开关组合1：SwitchArray1
    % ---- 开关组合信息：0 1 1 1 0 1 1 1 1 1 0 1 1.37 -31.80 1918
    SwitchArray1 = [0 1 1 1 0 1 1 1 1 1 0 1 1.37 -31.80 1918];
%% ---- 创建开关组合2：SwitchArray2
    % ---- 开关组合信息：0 0 1 1 1 1 1 1 0 1 1 0 1.75 -29.09 1015
    SwitchArray2 = [0 0 1 1 1 1 1 1 0 1 1 0 1.75 -29.09 1015];
%{
...
%% ---- 将所有开关组合存入一个数组中
    % ---- 定义SwitchArrayOfOneFrequencyPoint
        %{ 
            ...
            ---- 注意 ----
        %}
        SwitchArrayOfOneFrequencyPoint = [SwitchArray1; SwitchArray2];
