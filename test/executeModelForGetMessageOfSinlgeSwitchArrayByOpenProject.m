...
%% ---- 定义文件名
     %{
        ...
        ---- 注意 ----
    %}
    fileName = 'MessageOfSingleSwitchArray';
%% ---- 创建工程文件
...
%% ---- 打开工程和设计文件
    % ---- 设置工程文件的绝对路径
        %{
            ...
            ---- 注意 ----
            ---- 注意 ----
                此处必须是hfssProjectFile绝对路径
                该文件必须存在，否则会报错
                
                BasicModelNoSwitch.aedt文件里面除了开关以外，其他的部分均已经建立完毕
                因此建模脚本里面只需要开关的建模部分就够了
                可以节约一部分时间
            ---- 注意 ----
            ---- 注意 ----
            ---- 注意 ----
    ...
    % ---- 设置设计名称
        %{
            ...
            ---- 注意 ----
            ---- 注意 ----
                设计名称一定要和hfssProjectFile里面的设计名称完全一致
                否则会报错
            ---- 注意 ----
            ---- 注意 ----
            ---- 注意 ----
...
%% ---- 使用脚本建模
    % ---- 加载模型脚本
        %{
            ...
            ---- 注意 ----
        %}
    createUniteReconfigurableAntennaModelForOpenProject;
%% ---- 加载setupParametersOfHFSS脚本
    %{
        ...
        ---- 注意 ----
    %}
    setupParametersOfHFSSForGetMessageOfSingleSwitchArray;
%% ---- 添加求解频率
